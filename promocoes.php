<?php
// promocoes.php — Lista dinâmica das promoções via API
...
<head>
    ...
    <title>Crock Cookies - Promoções</title>
...
<nav class="menu-nav">
    ...
    <a href="promocoes.php" class="active">Promoções</a>
        ...
        <div class="cards-container">
            ...
            <?php if ($error): ?>
                <p style="color:red; font-size:18px; text-align:center;">
                    Erro ao carregar promoções: <?= htmlspecialchars($error) ?>
                </p>
            ...
            <?php else: ?>
                <p style="text-align:center;">Nenhuma promoção cadastrada.</p>
            <?php endif; ?>
